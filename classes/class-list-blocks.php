...
class Mai_List_Blocks {
	...
	function register_styles() {
		...
		wp_register_style( 'mai-list', MAI_LISTS_PLUGIN_URL . sprintf( 'assets/mai-lists%s.css', $suffix ), [], MAI_LISTS_VERSION . '.' . date( 'njYHi', filemtime( MAI_LISTS_PLUGIN_DIR . sprintf( 'assets/mai-lists%s.css', $suffix ) ) ) );
	}
	...
	function register_blocks() {
		...
		acf_register_block_type(
			[
				...
				'api_version'       => 2,
				'acf_block_version' => 2,
				// 'style'             =>  'file:' . MAI_LISTS_PLUGIN_URL . sprintf( 'assets/mai-lists%s.css', $suffix ),
				'style'             => 'mai-list',
				'supports'          => [
					'align'  => false,
					'anchor' => true,
...
add_action( 'enqueue_block_assets',        'mai_lists_enqueue' );
add_action( 'enqueue_block_editor_assets', 'mai_lists_enqueue' );
function mai_lists_enqueue() {
	$suffix = mai_lists_get_suffix();
	// wp_register_style( 'mai-list', MAI_LISTS_PLUGIN_URL . sprintf( 'assets/mai-lists%s.css', $suffix ), [], MAI_LISTS_VERSION . '.' . date( 'njYHi', filemtime( MAI_LISTS_PLUGIN_DIR . sprintf( 'assets/mai-lists%s.css', $suffix ) ) ) );
